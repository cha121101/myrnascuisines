...
<head>
    ...
    <title>New Event Reservation Mail</title>
</head>
<body>
    ...
    <section>
        ...
        <h1 class="text-3xl lg:text-4xl font-bold text-center text-gray-800 font-Geologica p-10">HI! There is a New <span class="underline underline-offset-4 decoration-red-600">Event Reservation</span> Form submitted to the website.</h1>
    ...
    <!--
    <section>
        <h1>HI! There is a New Event Reservation Form submitted to the website.</h1>
        <div>
            <ul>
