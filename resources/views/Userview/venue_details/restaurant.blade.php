                ...
                <div class="flex items-center justify-center h-52 md:h-72 xl:h-screen px-4 mx-auto my-auto z-50">
                    ...
                    <div class="grid">
                        <div class="text-center">
                            <h1 class="text-xl md:text-3xl xl:text-7xl font-geologica font-bold drop-shadow-2xl text-white">Restaurant</h1>
        ...
        <section class="p-5 bg-red-800">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantshort_1.jpg")}}" alt="">
                    </div>
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantlong_1.jpg")}}" alt="">
                    </div>
                   
                </div>
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantlong_2.jpg")}}" alt="">
                    </div>
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantshort_2.jpg")}}" alt="">
                    </div>
                    
                </div>
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantshort_3.jpg")}}" alt="">
                    </div>
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantlong_3.jpg")}}" alt="">
                    </div>
                  
                </div>
                <div class="grid gap-4">
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantlong_4.jpg")}}" alt="">
                    </div>
                    <div>
                        <img class="h-auto max-w-full rounded-lg" src="{{URL::asset("/img/restaurantshort_6.jpg")}}" alt="">
                    </div>
