...
<body class="bg-orange-50">
    ...
    <!--CRUD Section-->
        <section>
            <div class="sm:ml-72 print:sm:ml-0">
                <!--Time & Date-->
                ...
                <!--FORM-->
                    <div class="mt-16 ml-10 overflow-hidden bg-red-800 shadow-md rounded-l-2xl md:mt-10 md:ml-0">
                        <h1 class="m-10 text-3xl md:text-4xl xl:text-5xl font-bold text-white underline md:m-16 font-geologica underline-offset-8">Table Reservation Management</h1>

                        <!--TABLE HEADING-->
                            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4 print:hidden">
                                <div class="w-full md:w-1/2">

                                    <form action="{{ route('search.reservation.table') }}" type="submit" method="GET" class="flex items-center">
                                    <!--SEARCH-->
                                        ...
                                        <div class="flex items-center justify-center">
                                            ...
                                            <div id="dropdown" class="z-10 w-auto hidden p-3 bg-white rounded-lg shadow-2xl border-2 border-red-700 ">
                                                ...
                                                <ul class="space-y-2 font-geologica text-lg py-3" aria-labelledby="dropdownDefault">
                                                    ...
                                                    <div class="grid  md:grid-cols-2 xl:grid-cols-4 gap-1 mb-4">
                                ...
                                <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                                    ...
                                    <a type="button" href="{{ route('Userview.Reservation.table') }}" id="createProductModalButton" data-modal-target="createProductModal" data-modal-toggle="createProductModal" class="flex items-center justify-center text-white bg-primary-700 hover:bg-primary-800  dark:bg-primary-600 dark:hover:bg-primary-700  bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-geologica font-extrabold rounded-lg text-sm px-4 py-2.5 text-center">
                        ...
                        <!--TABLES AND ROWS-->
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm text-left text-gray-500">
                                    ...
                                    <!--DISPLAY INFORMATION-->
                                    <tbody>
                                        @forelse ($reservationtable as $key => $val )
                                            <tr class="text-lg font-extrabold text-black bg-white border-b border-red-700 font-geologica">
                                                ...
                                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                    <div class="flex items-center space-x-4">
                                                        <a type="button" href="{{ route('edit.management.table', ['id' => $val->customer_id])  }}" data-drawer-target="drawer-update-product" data-drawer-show="drawer-update-product" aria-controls="drawer-update-product" class="flex items-center text-white bg-primary-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none  dark:bg-primary-600 dark:hover:bg-primary-700   bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br  focus:ring-green-300 dark:focus:ring-green-800 font-geologica font-extrabold text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 -ml-0.5" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                                <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                                                <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                                            </svg>
                                                            <span class="text-base font-Geologica">Edit</span>
                                                        </a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @empty
                                        <div class="flex items-center p-4 mb-4 text-base font-extrabold text-center text-white rounded-lg font-nunito " role="alert">
                                            <svg class="flex-shrink-0 inline w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
                                            </svg>
                                            <span class="sr-only">Info</span>
                                            <div class="text-white">
                                            <span class="font-extrabold font-Geologica">No </span>Table Reservations.
                                            </div>
                                        </div>
                                        @endforelse
                                    </tbody>
