...
<head>
    ...
    <title>Table Management Form Details</title>
                ...
                <!--FORM-->
                    <div class="overflow-hidden bg-opacity-75 max-w-screen">
                        <div class="w-full px-10 mx-auto text-center font-Geologica lg:text-left">
                            <p class="flex px-5 py-5 my-10 text-3xl font-extrabold text-center text-white underline bg-red-700 md:text-4xl xl:text-5xl font-geologica font-Geologica underline-offset-8 decoration-white">Table Management Form Details</p>
                            @forelse($data as $key => $val )
                            <form action="{{ route('action.management.table') }}" onsubmit="action.disabled = true; return true;" enctype="multipart/form-data" method="POST"  >
                                @csrf
                                        ...
                                        <!--Reservation Details-->
                                            <div class="grid mb-6 xl:grid-cols-2">
                                                    ...
                                                    <!--Date Selection-->
                                                        <div class="mb-6 text-center rounded-lg">
                                                            <div class="relative mb-6 text-center">
                                                                ...
                                                                <input type="date" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" name="scheduledate" id="" value="{{$val->scheduledate}}">
                                                            </div>
                                                        </div>   
                                                    <!--Date Selection-->
                                                    ...
                                                    <!--Package,Venue,Noofpax-->
                                                        <div class="mb-6">
                                                            <div class="grid xl:col-span-2">
                                                                ...
                                                                <select name="tablenumber" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" id="">
                                                                    <optgroup>
                                                ...
                                                <div class="grid items-center justify-center xl:col-span-2">
                                                            ...
                                                            <div class="relative w-full max-w-md max-h-full">
                                                                <div class="relative bg-white rounded-lg shadow">
                                                                    ...
                                                                    <div class="p-6 text-center">
                                                                        ...
                                                                        <button data-modal-hide="popup-modal-1"name="action" value="confirm" id="acceptbtn" type="submit" class="text-white bg-green-500 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                                                            Yes, I'm sure
                                                                        </button>
                                                    ...
                                                    <!--Edit Modal-->
                                                        <button data-modal-target="popup-modal-2" data-modal-toggle="popup-modal-2" id="edittogglebtn" class="w-[15rem] h-[4rem] bg-green-500  hover:bg-green-400 hover:-translate-y-1 hover:scale-110 duration-300 text-center rounded-xl font-Geologica font-semibold text-2xl text-white mt-10 mb-10 print:hidden" type="button">
                                                            Edit
                                                        </button>
                            ...
                            if(element.x == data.scheduledate && isokay){
                                if(isokay){
                                    if(document.getElementById('scheduledate').value == element.x && data.scheduletime == document.getElementById('scheduletime').value && document.getElementById('table').value == data.tablenumber  ){ 
                                        ...
                                        document.getElementById('completetogglebtn').innerHTML = 'Accept';
