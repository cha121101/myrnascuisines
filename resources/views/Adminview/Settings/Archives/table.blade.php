...
<head>
    ...
    <title>Table Reservation Archive</title>
            ...
            <nav class="fixed top-0 z-50 w-full">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        ...
                        <!--Side Navbar Button-->
                            <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 mt-2 mr-3 text-sm text-red-700 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200">
                        ...
                        <!--Module Title-->
                            <nav class="bg-red-800 border-gray-200">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    <h1 class="m-10 text-4xl font-bold text-white underline md:m-16 md:text-5xl font-geologica underline-offset-8">Table Reservations Archive</h1>
                                </div>
                            </nav>
                        <!--Module Title-->
                            ...
                            <!--TABLE HEADING-->
                                <div class="flex flex-col items-center justify-between p-4 space-y-3 bg-red-800 md:flex-row md:space-y-0 md:space-x-4 print:hidden">
                                    <div class="w-full md:w-1/2">
                                        ...
                                        <form action="{{ route('search.archive.table') }}" type="submit" method="GET" class="flex items-center">
                                            ...
                                            <!--FILTER-->
                                                <div class="flex items-center justify-center bg-slate-50 rounded-r-lg">
                                                    <button id="dropdownDefault" data-dropdown-toggle="dropdown" class="text-gray-800 bg-slate-50 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-geologica font-bold rounded-r-lg text-lg px-6 py-2.5 text-center inline-flex items-center" type="button">
                                                    Filter
                                                    ...
                                                    <div id="dropdown" class="z-10 w-auto hidden p-3 bg-white rounded-lg shadow-2xl border-2 border-red-700 ">
                                                        <h1 class="py-3 text-xl xl:text-2xl font-geologica font-extrabold text-gray-800 text-center">
                                                            Filter by:
                                                        </h1>
                                                        ...
                                                        <ul class="space-y-2 font-geologica text-lg py-3" aria-labelledby="dropdownDefault">
                                                            ...
                                                            <!--YEAR-->
                                                               <div class="w-full">
                                                                    <button id="DRP01" data-dropdown-toggle="dropdownDefaultCheckbox1" class="w-full text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-base px-5 py-2.5 text-center justify-center inline-flex items-center" type="button">MONTH <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                                                        </svg>
                                                                        </button>
                                                                        ...
                                                                        <div id="dropdownDefaultCheckbox1" class="shadow-2xl border-2 border-red-700 z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg">
                                                                            <ul class="p-3 space-y-3 h-52 overflow-y-auto text-lg font-bold text-gray-700" aria-labelledby="DPR01">                                                                                                                                          
                                                                                @for ($month = 1; $month <= 12; $month++)
                                                                                    <li>
                                                                                        <div class="flex items-center">
                                                                                            <input type="checkbox" name="months[]" value="{{ $month }}" id="month-{{ $month }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                            <label for="month-{{ $month }}" class="ms-2 text-gray-900">{{ date('F', mktime(0, 0, 0, $month, 1)) }}</label>
                                                                                        </div>
                                                                                    </li>
                                                                                @endfor    
                                                                            <ul>                                                                  
                                                            ...
                                                            <!--DAY-->
                                                                <div class="w-full">    
                                                                    <button id="DRP02" data-dropdown-toggle="dropdownDefaultCheckbox2" class="w-full text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-base px-5 py-2.5 text-center justify-center inline-flex items-center" type="button">DAY <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                                                        </svg>
                                                                        </button>
                                                                            
                                                                        <!-- Dropdown menu -->
                                                                        <div id="dropdownDefaultCheckbox2" class="shadow-2xl border-2 border-red-700 z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg">
                                                                            <ul class="p-3 space-y-3 h-52 text-lg font-bold overflow-y-auto text-gray-700" aria-labelledby="DRP02">
                                                                                @for ($day = 1; $day <= 31; $day++)
                                                                                <li>
                                                                                    <div class="flex items-center">
                                                                                        <input type="checkbox" name="days[]" value="{{ $day }}"class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        <label class="ms-2 text-gray-900">{{ $day }}</label>
                                                                                    </div>
                                                                                <li>
                                                                                @endfor  
                                                                            </ul>
                                                            ...
                                                            <!--VENUE-->
                                                                <div class="w-full">
                                                                    ...
                                                                    <button id="DRP03" data-dropdown-toggle="dropdownDefaultCheckbox3" class="w-full text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-base px-5 py-2.5 text-center justify-center inline-flex items-center" type="button">TABLE<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                                                        </svg>
                                                                        </button>
                                                                        ...
                                                                        <div id="dropdownDefaultCheckbox3" class="shadow-2xl border-2 border-red-700  z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg">
                                                                            <ul class="p-3 space-y-3 text-lg font-bold text-gray-700" aria-labelledby="DRP03">
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" name="tables[]" value="Table 1" id="table_1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                                                                    <label class="ms-2 text-gray-900" for="table_1">Table 1</label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" name="tables[]" value="Table 2" id="table_2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                                                                    <label class="ms-2 text-gray-900" for="table_2">Table 2</label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" name="tables[]" value="Table 3" id="table_3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                                                                    <label class="ms-2 text-gray-900" for="table_3">Table 3</label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" name="tables[]" value="Table 4" id="table_4" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                                                                    <label class="ms-2 text-gray-900" for="table_4">Table 4</label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" name="tables[]" value="Table 5" id="table_5" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 " >
                                                                                    <label class="ms-2 text-gray-900" for="table_5">Table 5</label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <input type="checkbox" name="tables[]" value="Table 6" id="table_6" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 ">
                                                                                    <label class="ms-2 text-gray-900" for="table_6">Table 6</label>
                                                                                </div>
                                                            ...
                                                            <!--TIME-->
                                                                <div class="w-full">
                                                                    ...
                                                                    <button id="DRP04" data-dropdown-toggle="dropdownDefaultCheckbox4" class="w-full text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-base px-5 py-2.5 text-center justify-center inline-flex items-center" type="button">TIME <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                                                        </svg>
                                                                        </button>
                                                                        
                                                                        <!-- Dropdown menu -->
                                                                        <div id="dropdownDefaultCheckbox4" class="shadow-2xl border-2 border-red-700  z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg">
                                                                            <ul class="p-3 space-y-3 h-52 text-lg font-bold text-gray-700 overflow-y-auto " aria-labelledby="DRP04">
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="8:00 AM - 8:00 AM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        8:00 AM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">                                                                            
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="9:00 AM - 9:00 AM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        9:00 AM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">                                                                            
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="10:00 AM - 10:00 AM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        10:00 AM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="11:00 AM - 11:00 AM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        11:00 AM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="12:00 AM - 12:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        12:00 PM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="1:00 PM - 1:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        1:00 PM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="2:00 PM - 2:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        2:00 PM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="3:00 PM - 3:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        3:00 PM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="4:00 PM - 4:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        4:00 PM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 ">
                                                                                        <input type="checkbox" name="times[]" value="5:00 PM - 5:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        5:00 PM 
                                                                                    </label>
                                                                                </div>
                                                                                <div class="flex items-center">
                                                                                    <label class="ms-2 text-gray-900 "> 
                                                                                        <input type="checkbox" name="times[]" value="6:00 AM - 6:00 PM" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        6:00 PM 
                                                                                    </label> 
                                                                                </div>
                                                                            </ul>
                                                            ...
                                                            <!--YEAR-->
                                                                <div class="w-full">                                                          
                                                                    <button id="DRP04" data-dropdown-toggle="dropdownDefaultCheckbox5" class="w-full text-white bg-gray-700 hover:bg-gray-800 font-medium rounded-lg text-base px-5 py-2.5 text-center justify-center inline-flex items-center" type="button">YEAR <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                                                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
                                                                        </svg>
                                                                        </button>
                                                                        
                                                                        <!-- Dropdown menu -->
                                                                        <div id="dropdownDefaultCheckbox5" class="shadow-2xl border-2 border-red-700  z-10 hidden w-48 bg-white divide-y divide-gray-100 rounded-lg">
                                                                            <ul class="p-3 space-y-3 h-52 text-lg font-bold text-gray-700 overflow-y-auto" aria-labelledby="DRP04">
                                                                                <li>
                                                                                    @for ($year = date('Y'); $year >= 2020; $year--)
                                                                                    <div class="flex items-center">
                                                                                        <input type="checkbox" name="years[]" value="{{ $year }}" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500">
                                                                                        <label class="ms-2 text-gray-900">{{ $year }}</label>
                                                                                    </div>
                                                                                    @endfor
                                                                                </li>
                                                                            </ul>
                            ...
                            <!--TABLES AND ROWS-->
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm text-left text-gray-500">
                                        ...
                                        <!--DATA TYPES-->
                                            <thead class="text-sm font-extrabold text-black uppercase bg-white border-b-2 border-black font-geologica">
                                                <tr>
                                                    ...
                                                    <th scope="col" class="px-4 py-3">Table Number</th>
                                        ...
                                        <!--DISPLAY INFORMATION-->
                                            <tbody>
                                                @forelse ( $archivestables as $key => $val )
                                                    <tr class="text-lg font-extrabold text-black bg-white border-b border-red-700 font-geologica">
                                                        <th scope="row" class="px-4 py-3 whitespace-nowrap">{{ $val->firstname }} {{ $val->lastname }}</th>
                                                        <td class="px-4 py-3">{{ $val->tablenumber }}</td>
                                                        <td class="px-4 py-3">+63-{{ $val->phonenumber }}</td>
                                                        <td class="px-4 py-3">{{ $val->scheduledate }}</td>
                                                        <td class="px-4 py-3">{{ $val->scheduletime }}</td>
                                                        <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                            <div class="flex items-center space-x-4">
                                                                <a type="button" href="{{ route('archives.form.table', ['id' => $val->customer_id]) }}" data-drawer-target="drawer-update-product" data-drawer-show="drawer-update-product" aria-controls="drawer-update-product" class="flex items-center px-5 py-2 mb-2 mr-2 text-sm font-extrabold text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none dark:bg-primary-600 dark:hover:bg-primary-700 bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-green-300 dark:focus:ring-green-800 font-geologica">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 -ml-0.5" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                                        <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                                                        <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                                                    </svg>
                                                                    <span class="text-base font-Geologica">View</span>
                                                                </a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                ...
                                                <div class="flex items-center p-4 mb-4 text-base font-extrabold text-center text-white bg-red-800 font-nunito " role="alert">
                                                    ...
                                                    <div class="text-white">
                                                        <span class="font-extrabold font-Geologica">No </span>Table Reservation Form.
                                                    </div>
                                                </div>
                                                @endforelse
                                            </tbody>
