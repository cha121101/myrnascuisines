            ...
            <div class="sm:ml-64 print:sm:ml-0">
                ...
                <div class="overflow-hidden bg-opacity-75 max-w-screen">
                    <div class="w-full px-10 mx-auto text-center font-Geologica lg:text-left">
                        <p class="flex px-5 py-5 my-10 text-3xl font-extrabold text-center text-white underline bg-red-700 md:text-5xl font-geologica font-Geologica underline-offset-8 decoration-white">Table History Form Details</p>
