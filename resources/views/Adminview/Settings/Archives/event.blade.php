...
<head>
    ...
    <title>Event Reservation Archive</title>
                        ...
                        <!--Module Title-->
                            <nav class="bg-red-800 border-gray-200">
                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                    <h1 class="m-10 text-4xl font-bold text-white underline md:m-16 md:text-5xl font-geologica underline-offset-8">Event Reservations Archive</h1>
                                </div>
                            </nav>
                        <!--Module Title-->
                            ...
                            <!--TABLE HEADING-->
                                <div class="flex flex-col items-center justify-between p-4 space-y-3 bg-red-800 md:flex-row md:space-y-0 md:space-x-4 print:hidden">
                                    <div class="w-full md:w-1/2">
                                        ...
                                        <form action="{{ route('search.archive.event') }}" type="submit" method="GET" class="flex items-center">
                                            <!--SEARCH-->
                            ...
                            <!--TABLES AND ROWS-->
                                <div class="overflow-x-auto">
                                    <table class="w-full text-sm text-left text-gray-500">
                                        ...
                                        <!--DISPLAY INFORMATION-->
                                            <tbody>
                                                @forelse ( $archivesevents as $key => $val )
