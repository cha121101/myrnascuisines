...
<head>
    ...
    <title>Table Reservation Reports</title>
        ...
        <section>
            <div class="sm:ml-72 print:sm:ml-0">
                ...
                <div class="mt-16 ml-10 overflow-hidden bg-red-800 shadow-md rounded-l-2xl md:mt-10 md:ml-0">
                    <h1 class="m-10 text-3xl md:text-4xl xl:text-5xl font-bold text-white underline md:m-16 font-geologica underline-offset-8">Table Reservation Reports</h1>
                    ...
                    <!--TABLE HEADING-->
                        <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4 print:hidden">
                            <div class="w-full md:w-1/2">
                                ...
                                <form action="{{ route('search.history.table') }}" type="submit" method="GET" class="flex items-center">
                    ...
                    <!--TABLES AND ROWS-->
                        <div class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500">
                                ...
                                <!--DISPLAY INFORMATION-->
                                    <tbody>
                                        @forelse ($historytables as $key => $val )
