...
<head>
    ...
    <title>Event Reservation Form Details</title>
                ...
                <!--FORM-->
                    <div class="overflow-hidden bg-opacity-75 max-w-screen">
                        <div class="w-full px-10 mx-auto text-center font-Geologica lg:text-left">
                            <p class="flex px-5 py-5 my-10 text-3xl md:text-4xl xl:text-5xl font-extrabold text-center text-white underline bg-red-700 font-geologica font-Geologica underline-offset-8 decoration-white">
                                Event Reports Form Details
                            </p>
                                            ...
                                            <div>
                                                <!--Fname,Lname,Address,Phonenumber-->
                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                        <div>
                                                            ...
                                                            <input disabled type="text" name="firstname" id="firstname" onchange="checkfirstname()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->firstname }}" placeholder="First Name"  autocomplete="off">
                                                        </div>

                                                        <div>
                                                            <p class="flex text-sm font-extrabold text-left text-black font-nunito input-icon input-icon-right">Last Name</p>
                                                            <input disabled type="text" name="lastname" id="lastname"  onchange="checklastname()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->lastname }}" placeholder="Last Name"  autocomplete="off">
                                                        </div>

                                                        <div>
                                                            <p class="flex text-sm font-extrabold text-left text-black font-nunito input-icon input-icon-right">Address</p>
                                                            <input disabled type="text"  name="address"  id="address" onchange="checkaddress()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->address }}" placeholder="Address"  autocomplete="off">
                                                        </div>  
                                                ...
                                                <!--Email-->
                                                    <div>
                                                        ...
                                                        <input disabled type="email" name="email" id="email" onchange="checkemail()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->email }}" placeholder="Myrnas@gmail.com"  autocomplete="off">
                                                    </div>
                                                <!--Email-->
                                                    ...
                                                    <script>
                                                                function changepackage(){
                                                                    switch (document.getElementById("packages").value) {
                                                                        case "Package A":
                                                                            document.getElementById("packageprice").value = 380;
                                                                            break;
                                                                        case "Package B":
                                                                            document.getElementById("packageprice").value = 380;
                                                                        break;
                                                                        case "Package C":
                                                                            ...
                                                                            break;
                                                                        case "Package D":
                                                                            document.getElementById("packageprice").value = 400;
                                                                        break;
                                                                        case "Package E":
                                                                            document.getElementById("packageprice").value = 450;
                                                                            break;
                                                                        default:
                                                                            break;
                                                                    }
                                                ...
                                                <!--Package,Venue,Noofpax-->
                                                    <div>
                                                            ...
                                                            <script>
                                                                function changevenue(){
                                                                    ...
                                                                    if(pickvenue === "RESTAURANT"){
                                                                        document.getElementById('venueprice').value = 10000;
                                                        ...
                                                        <div class="mb-6 text-left">
                                                            <label for="phone" class="flex text-sm font-extrabold text-left text-black font-nunito input-icon input-icon-right">Customer Notes</label>
                                                            <textarea disabled type="text" name="specialrequest" id="" rows="12" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500">{{$val->specialrequest}}</textarea>
                                                        </div>
                                                    </div>
                                                <!--Package,Venue,Noofpax-->
                                            </div>
                                                        ...
                                                        <div class="text-center rounded-lg">
                                                            ...
                                                            <!--VENUE SELECTION-->
                                                                <div class="mb-6">
                                                                    ...
                                                                    <!--Venue Selection-->
                                                                    <select disabled name="venue" id="venue" onchange="changevenue()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" id=""  autocomplete="off">
                                                            ...
                                                            <!--ADD ON VENUES-->
                                                                <div class="col-span-2 mb-4">
                                                                    <div id="addonrestaurantview" class="flex items-center pl-4 my-2 bg-white border border-black rounded">
                                                                        <input disabled type="checkbox" name="venueaddon[]" id="addongazebo" class="" value="Gazebo">
                                                                    ...
                                                                    <div id="addongazeboview" class="flex items-center pl-4 my-2 bg-white border border-black rounded">
                                                                        <input disabled type="checkbox" name="venueaddon[]" id="addonrestaurant"  class="" value="Restaurant">
                                                                    ...
                                                                    <div  id="addoneventhallview" class="flex items-center pl-4 my-2 bg-white border border-black rounded">
                                                                        <input disabled type="checkbox" name="venueaddon[]" id="addoneventhall"  class="" value="Event Hall">
                                                                    ...
                                                                    <div   id="addonpoolview" class="flex items-center pl-4 my-2 bg-white border border-black rounded">
                                                                        <input disabled type="checkbox" name="venueaddon[]" id="addonpool"   class="" value="Pool Area">
                                                                    ...
                                                                    @if ($addons != null)
                                                                        ...
                                                                        @endif
                                                                        @if ($val->venue == "EVENT HALL")
                                                                            <script>
                                                                                document.getElementById('addoneventhall').classList.add('hidden')
                                                                                document.getElementById('addonpool').classList.remove('hidden')
                                                                            </script>
                                                                        @endif
                                                                        @if ($val->venue == "POOL AREA")
                                                                            <script>
                                                                                document.getElementById('addoneventhallview').classList.add('hidden')
                                                                                document.getElementById('addonpoolview').classList.add('hidden')
                                                                                document.getElementById('addonrestaurantview').classList.add('hidden')
                                                            ...
                                                            <!--PACKAGE SELECTION-->
                                                                <div>
                                                                    ...
                                                                    <!--Package Selection-->
                                                                    <select disabled name="package" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" onchange="changepackage()" id="packages">
                                                                        @switch($val->package)
                                                                        @case('package_a')
                                                                    ...
                                                                    @endswitch
                                                                        <optgroup>
                                                                            ...
                                                                            <option value="package_e" default>Package D</option>
                                                    ...
                                                    <div class="xl:mx-[2rem] font-Geologica justify-items-center">
                                                            ...
                                                            <div class="relative mb-6 text-center">
                                                                <p class="flex text-sm font-extrabold text-left text-black font-nunito input-icon input-icon-right">Time</p> 
                                                                    <div class="relative text-center">
                                                                        <select disabled id="scheduletime" name="scheduletime" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" >
                                                                            <optgroup>
                                                        ...
                                                        <!--Venue Price--> 
                                                            <div class="mb-6">
                                                                ...
                                                                <input type="number" disabled class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" id="venueprice" name="venueprice" value={{ $val->venueprice}}>
                                                            </div>
                                                        <!--Venue Price--> 
                                                        ...
                                                        <!--Package Price-->
                                                            <div class="mt-16"> 
                                                                ...
                                                                <input type="text" disabled class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" id="packageprice" name="packageprice" value={{ $val->packageprice}}>
                                                            </div>
                                                        <!--Package Price-->
