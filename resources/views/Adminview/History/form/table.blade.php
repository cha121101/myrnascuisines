...
<head>
    ...
    <title>Table Reservation Form Details</title>
                ...
                <!--FORM-->
                    <div class="overflow-hidden bg-opacity-75 max-w-screen">
                        <div class="w-full px-10 mx-auto text-center font-Geologica lg:text-left">
                            <p class="flex px-5 py-5 my-10 text-3xl md:text-4xl xl:text-5xl font-extrabold text-center text-white underline bg-red-700 font-geologica font-Geologica underline-offset-8 decoration-white">Table Archive Form Details</p>
                            ...
                            <form action="{{ route('action.management.table') }}" onsubmit="action.disabled = true; return true;" enctype="multipart/form-data" method="POST"  >
                                {{-- @csrf
                                <input disabled type="hidden" name="id" value="{{ $val->id }}">
                                <input disabled type="hidden" name="customer_id" value="{{ $val->customer_id }}"> 
                                <input disabled type="hidden" name="name" value="{{ Auth::user()->name }}">  --}}
                                <!--FORM INPUT-->
                                            ...
                                            <div>
                                                ...
                                                <!--Fname,Lname,Address,Phonenumber-->
                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                        <div>
                                                            ...
                                                            <input disabled type="text" disabled name="firstname" id="firstname" onchange="checkfirstname()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->firstname }}" placeholder="First Name">
                                                        </div>

                                                        <div>
                                                            <p class="flex text-sm font-extrabold text-left text-black font-nunito input-icon input-icon-right">Last name</p> 
                                                            <input disabled type="text" name="lastname" id="lastname" onchange="checklastname()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->lastname }}" placeholder="Last Name">
                                                        </div>

                                                        <div>
                                                            <p class="flex text-sm font-extrabold text-left text-black font-nunito input-icon input-icon-right">Address</p> 
                                                            <input disabled type="text"  name="address"  id="address" onchange="checkaddress()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->address }}" placeholder="Address">
                                                        </div>  
                                                ...
                                                <!--Email-->
                                                    <div class="mb-6">
                                                        ...
                                                        <input disabled type="email" name="email" id="email" onchange="checkemail()" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" value="{{$val->email }}" placeholder="Myrnas@gmail.com" required>
                                                    </div>
                                                <!--Email-->
                                                ...
                                                <div class="xl:mx-[2rem] font-Geologica justify-items-center">
                                                    ...
                                                    <div class="mb-6 text-center rounded-lg">
                                                        <div class="relative mb-6 text-center">
                                                            ...
                                                            <input disabled type="date" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" name="scheduledate" id="" value="{{$val->scheduledate}}">
                                                        </div>
                                                    </div>   
                                                    <!--Date Selection-->
                                                    ...
                                                    <!--Package,Venue,Noofpax-->
                                                        <div class="mb-6">
                                                            <div class="grid xl:col-span-2">
                                                                ...
                                                                <select disabled name="tablenumber" class="bg-gray-50 border text-gray-900 font-geologica font-extrabold text-base rounded-lg focus:ring-blue-500  block w-full p-2.5 dark:placeholder-gray-400 dark:focus:ring-blue-500" id="">
                                                                    <optgroup>
